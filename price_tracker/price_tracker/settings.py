...
SECRET_KEY = 'django-insecure-%&azu86vf0(i#5^(ltri!7e5t8xu^^&7isk_wr_f*(6#hrf=yj'
...
# Recommended Redis settings for reliability
...
CELERY_RESULT_EXPIRES = 3600  # Task results expire in 1 hour
